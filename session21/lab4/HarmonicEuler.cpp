...
int main()
{
	...
	TCanvas* c1 = new TCanvas("Harmonic Motion - Euler Method");
	c1->SetTitle("Simple Pendulum - Euler Method");

	TGraph* g1 = new TGraph(timeSteps, timeAt, theta);

	g1->SetTitle("Simple Pendulum - Euler Method;time (s);theta (radians)");
